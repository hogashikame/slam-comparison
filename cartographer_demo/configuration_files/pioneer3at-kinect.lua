...
options = {
  ...
  map_frame = "map",
  tracking_frame = "kinect2_ir_link",
...
--TRAJECTORY_BUILDER_2D.use_imu_data = false
--T-RAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 1e3
--TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.linear_search_window = 0.5
--TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.angular_search_window = 0.5
