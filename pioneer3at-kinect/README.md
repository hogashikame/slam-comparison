...
directory contains a ROS package named `pioneer_hokuyo_description`.
...
For more details on using these models and the `pioneer_hokuyo_description` package, see [description/README.md](description/README.md)
...
`pioneer_hokuyo_gazebo` which can be used to reference files contained
